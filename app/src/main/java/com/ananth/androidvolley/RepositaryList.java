...
public class RepositaryList extends AppCompatActivity {
    ...
    private void fetchReposList(String name) {
        String url = mUrl + name + "/repos";
                        ...
                        if (array.length() > 0) {
                            for (int i = 0; i < array.length(); i++) {
                                try {
                                    ...
                                    mMap.put("name", mObject.getString("name"));
